...
const ErrorPage = () => {
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-purple-100 to-purple-200 px-6">
      <div className="text-center max-w-lg mx-auto py-16 relative">
        ...
        <div className="relative z-10">
          <h2 className="text-3xl font-bold text-purple-800 mb-8 drop-shadow-sm">
            페이지를 찾을 수 없습니다
          </h2>
          <p className="text-lg text-purple-700 mb-12 drop-shadow-sm">
